namespace Agony.RadialTabs
{
    ...
    public static class uGUI_CraftingMenuPatches
    {
        ...
        [HarmonyPrefix]
        public static bool IsGridPrefix(bool __result)
        {
            __result = false;
            return false;
        }
        ...
        public static void CreateIconPostfix(uGUI_CraftingMenu __instance, uGUI_CraftingMenu.Node node)
        {
            ...
            Vector2 vector = new Vector2(radialCell.size, radialCell.size);
            ...
            Vector2 position = !node.isRoot
                ? !(node.parent is uGUI_CraftingMenu.Node node2) || !node2.expanded ? radialCell.parent.Position : radialCell.Position
                : radialCell.Position;
